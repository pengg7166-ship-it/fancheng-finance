...
- **标签页**：`tab-outlook-core` / `nav-tab--core` 金琥珀渐变底、左侧 accent 条、◆ 图标、「核心」角标、7s 慢呼吸光晕；品种数 `data-live-count` 仍可用
- **面板头**：`outlook-core-header-strip` 横幅「核心研判 · 全板块数据汇入」+ `outlook-core-ribbon` CORE 角标
- 页脚版本 **v1.24.1**
