/**
 * 有色金属（CU/AL/ZN/PB/NI/SN…）下一交易'high/low 区间校准参数
...
const CAL_VERSION = 'nonferrous-range-v1';

/** 核心 SHFE 有色金属 '逐个校准 */
const CALIBRATED_IDS = ['cu', 'al', 'zn', 'pb', 'ni', 'sn', 'bc', 'ao', 'si', 'lc', 'ps', 'ss'];

const DEFAULT_PARAMS = {
  cu: { upMult: 1.35, downMult: 1.25, centerLean: 0.2, minSigmaPct: 0.01, volWindow: 20 },
  al: { upMult: 1.3, downMult: 1.2, centerLean: 0.2, minSigmaPct: 0.012, volWindow: 20 },
  zn: { upMult: 1.35, downMult: 1.3, centerLean: 0.2, minSigmaPct: 0.014, volWindow: 20 },
  pb: { upMult: 1.3, downMult: 1.25, centerLean: 0.2, minSigmaPct: 0.014, volWindow: 20 },
  ni: { upMult: 1.4, downMult: 1.35, centerLean: 0.15, minSigmaPct: 0.018, volWindow: 20 },
  sn: { upMult: 1.45, downMult: 1.4, centerLean: 0.15, minSigmaPct: 0.02, volWindow: 20 },
  bc: { upMult: 1.35, downMult: 1.25, centerLean: 0.2, minSigmaPct: 0.01, volWindow: 20, cuCrossBias: true },
  ao: { upMult: 1.3, downMult: 1.25, centerLean: 0.2, minSigmaPct: 0.015, volWindow: 20 },
  si: { upMult: 1.5, downMult: 1.5, centerLean: 0.15, minSigmaPct: 0.02, volWindow: 20 },
  lc: { upMult: 1.6, downMult: 1.6, centerLean: 0.15, minSigmaPct: 0.025, volWindow: 20 },
  ps: { upMult: 1.6, downMult: 1.6, centerLean: 0.15, minSigmaPct: 0.025, volWindow: 20 },
  ss: { upMult: 1.4, downMult: 1.35, centerLean: 0.15, minSigmaPct: 0.018, volWindow: 20, niCrossBias: true },
};
...
function calFilePath() {
  ...
  return path.join(base, 'outlook-models', 'nonferrous-range-calibration-v1.json');
}
...
/**
 * 有色金属区间：锚定昨收，上下不对称延'+ 可选方向偏'
 */
function computeNonferrousRangeBand(opts = {}) {
