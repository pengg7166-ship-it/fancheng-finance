/**
 * 黑色系（RB/HC/I/J/JM/SF/SM/WR…）下一交易'high/low 区间校准参数
...
const CAL_VERSION = 'black-range-v1';

/** 黑色—commodity-instrument-profiles ID_SECTOR=black，不'ss（有色金属已校准'*/
const CALIBRATED_IDS = ['rb', 'hc', 'i', 'j', 'jm', 'sf', 'sm', 'wr'];

const DEFAULT_PARAMS = {
  rb: { upMult: 1.35, downMult: 1.25, centerLean: 0.2, minSigmaPct: 0.012, volWindow: 20, iCrossBias: true },
  hc: { upMult: 1.3, downMult: 1.25, centerLean: 0.2, minSigmaPct: 0.012, volWindow: 20 },
  i: { upMult: 1.4, downMult: 1.35, centerLean: 0.18, minSigmaPct: 0.015, volWindow: 20, rbCrossBias: true },
  j: { upMult: 1.35, downMult: 1.3, centerLean: 0.18, minSigmaPct: 0.015, volWindow: 20, jmCrossBias: true },
  jm: { upMult: 1.35, downMult: 1.3, centerLean: 0.18, minSigmaPct: 0.015, volWindow: 20, jCrossBias: true },
  sf: { upMult: 1.35, downMult: 1.3, centerLean: 0.18, minSigmaPct: 0.014, volWindow: 20 },
  sm: { upMult: 1.35, downMult: 1.3, centerLean: 0.18, minSigmaPct: 0.014, volWindow: 20 },
  wr: { upMult: 1.3, downMult: 1.25, centerLean: 0.2, minSigmaPct: 0.012, volWindow: 20 },
};
...
function calFilePath() {
  ...
  return path.join(base, 'outlook-models', 'black-range-calibration-v1.json');
}
...
/**
 * 黑色系区间：锚定昨收，上下不对称延伸 + 可选方向偏'
 */
function computeBlackRangeBand(opts = {}) {
