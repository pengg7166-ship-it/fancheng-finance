...
function localizeErrorMessage(message) {
  ...
  const map = {
    ...
    'article-not-found': '新闻未找到或已过期',
    'blocked-scrape': '目标站点限制自动抓取',
    'federalregister-blocked': '联邦公报限制自动抓取',
    'too-short': '正文过短，暂无可用全文',
    'no-url': '该条资讯无原文链接',
    'news fetch failed': '新闻正文拉取失败',
    'ECONNRESET': '网络连接被重置',
    'ENOTFOUND': '无法解析新闻站点地址',
